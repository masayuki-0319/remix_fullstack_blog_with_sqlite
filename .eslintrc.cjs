...
module.exports = {
  ...
  overrides: [
    ...
    // Tests
    {
      files: ['*.{test}.{ts,tsx}', '**/__{tests}__/**/*.{ts,tsx}'],
    },
  ],
  ...
  rules: {
    ...
    'jsx-quotes': 0, // enforces the usage of double quotes for all JSX attribute values which doesn’t contain a double quote
    'comma-spacing': 0,
    'no-multi-spaces': 0,
